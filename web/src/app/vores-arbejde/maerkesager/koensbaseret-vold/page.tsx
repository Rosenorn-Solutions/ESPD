...
import bannerImageUrl from "./koensvold-banner.jpg";
import campaignScreenshotImage from "./koensvold-kaerlighedssprog.jpg";
import flowerImage from "./koensvold-flower.jpg";
import sitDownImage from "./koensvold-sitdown.jpg";
import unsplashImage from "./koensvold-unsplash.jpg";
...
const campaignVideoUrl = new URL("./koensvold-video.m4v", import.meta.url);
    ...
    <>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-[1200px] px-4 py-12 md:py-16">
          ...
          <div className="grid gap-10 md:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] md:items-start">
            <div className="space-y-4 font-body leading-relaxed text-body-text">
              ...
              <blockquote className="border-l-4 border-accent-gold pl-4 italic text-dark-text">
                ...
                udnyttelse.&rdquo;
                <br />
                <span className="text-sm not-italic">— FN&apos;s Verdensmål 5, delmål 5.2</span>
              </blockquote>
              <p>
          ...
          <div className="mt-12 grid gap-10 border-t border-light-gray pt-12 md:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] md:items-start">
            <div className="space-y-4 font-body leading-relaxed text-body-text">
              ...
              <p>
                Der er viden fra forskning om stadier før (eks)partnerdrab, som kan bruges til
                at lave en risikovurdering fra systemet, og det er vigtigt at ofre for vold kan
            ...
            <blockquote className="border-l-4 border-accent-gold pl-4 font-semibold italic text-dark-text md:self-center">
              &ldquo;Alle former for vold mod alle kvinder og piger i de offentlige og private rum
              skal elimineres, herunder menneskehandel og seksuel og andre former for
              udnyttelse.&rdquo;
              <br />
              <span className="text-sm not-italic">— FN&apos;s Verdensmål 5, delmål 5.2</span>
            </blockquote>
          ...
          <div className="mt-12 grid gap-10 border-t border-light-gray pt-12 md:grid-cols-[minmax(320px,0.95fr)_minmax(0,1.05fr)] md:items-start">
            <figure className="order-2 md:order-1">
              <div className="overflow-hidden rounded-sm bg-light-gray/20 shadow-sm">
                <Image
                  src={sitDownImage}
                  alt="Sit Down-aktion mod vold mod kvinder"
                  width={1024}
                  height={683}
                  className="h-auto w-full object-cover"
                />
            ...
            <div className="order-1 space-y-4 font-body leading-relaxed text-body-text md:order-2">
              ...
              <ul className="list-disc space-y-3 pl-6">
                <li>
                  Tal med dine nærmeste om at være opmærksom ved tegn på partnervold. Desværre
                  er det ofte ikke synligt, men lad mistanken komme et evt. offer til gode og
                  stol altid på den, der betror sig.
                </li>
                <li>
          ...
          <div className="mt-12 overflow-hidden rounded-sm border-t border-light-gray bg-light-gray/20 pt-12 shadow-sm">
            <Image
              src={unsplashImage}
              alt="Kvinde set bagfra i naturen"
              width={1024}
              height={683}
              className="h-auto w-full object-cover"
            />
          ...
          <div className="mt-12 grid gap-10 border-t border-light-gray pt-12 lg:grid-cols-2 lg:items-start">
            <div className="space-y-4">
              <div className="overflow-hidden rounded-sm bg-primary-black shadow-sm">
                <video
                  src={campaignVideoUrl.toString()}
              ...
              <div className="overflow-hidden rounded-sm bg-light-gray/20 shadow-sm">
                <Image
                  src={campaignScreenshotImage}
                  alt="Skærmbillede fra kampagnen De 5 kærlighedssprog"
                  width={1600}
                  height={900}
                  className="h-auto w-full object-cover"
                />
            ...
            <div className="space-y-4 font-body leading-relaxed text-body-text">
              ...
              <p>
                ...
                kærlige øjeblikke. Voldelige handlinger i et parforhold starter ofte i det små
                og udvikler sig gradvist, så volden normaliseres og kan blive en del af måden at
                være sammen på.
              </p>
              <p>
                Den 1. april 2020 er årsdagen for kriminaliseringen af psykisk vold i Danmark.
                De seneste tal viser, at det har resulteret i 182 anmeldelser og 53 sigtelser af
                psykisk vold på landsplan. Kriminaliseringen sender et klart signal om, at vi
                som samfund ikke accepterer denne form for vold — men vi skal stadig gøre mere,
                inden den psykiske vold udvikler sig til seksuel eller fysisk vold, og i værste
                instans ender i drab.
              </p>
              <p>
                <a
